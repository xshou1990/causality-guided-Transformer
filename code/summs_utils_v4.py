...
# A and B depend on A and B's prior occurrences; the others do not depend on prior occurrences
# prob of A and B combined is 0.8; B is an amplifier for A and B is an inhibitor for B
def wins_and_probs_example():

  windows_for_A_and_B = [4,4]
