...
parsed_args.batch_size = 16
parsed_args.n_head = 6
parsed_args.n_layers = 6
parsed_args.d_model = 128
parsed_args.d_inner = 256
parsed_args.d_k=128
parsed_args.d_v=128
parsed_args.dropout=0.1
parsed_args.lr=6e-4   #2.5e-5
parsed_args.epoch=500
parsed_args.type_z = 12 #          (C, B) , C excites B
parsed_args.type_y = 7 #  
...
parsed_args.alpha = 1
parsed_args.data = "data/diabetes_data/"
